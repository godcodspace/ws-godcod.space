  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
        {/* Newsletter Section */}
        <div className="bg-primary-600 rounded-2xl p-8 lg:p-12 mb-12">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-primary-100">
                Receba dicas exclusivas para escalar seu micro SaaS
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">GodCod</span>
            </div>
            <p className="text-gray-400 mb-6">
              Transforme suas ideias em produtos digitais de sucesso com nossa plataforma completa de micro SaaS.
            </p>
            {/* Social Links */}
            <div className="flex gap-4">
